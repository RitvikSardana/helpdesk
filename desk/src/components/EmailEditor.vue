<template>
  <TextEditor
    ref="editorRef"
    :editor-class="[
      'prose-sm max-w-none mx-2.5 lg:mx-10 max-h-[50vh] overflow-y-auto py-3',
      'min-h-[7rem]',
  ...
  >
    <template #top>
      <div class="mx-2.5 lg:mx-10 flex items-center gap-2 border-y py-2.5">
      ...
      <div
        v-if="showCC || cc"
        class="mx-2.5 lg:mx-10 flex items-center gap-2 py-2.5"
    ...
    <template #bottom>
      ...
      <div
        class="flex justify-between gap-2 overflow-hidden px-2.5 lg:px-10 py-2.5"
      >
